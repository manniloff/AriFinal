...
@Entity
@Table(name="alert_waiting_list")
public class AlertWaitingList {

	public AlertWaitingList() {
...
//	@Enumerated(EnumType.STRING)
	...
	public void setHandledType(String alertType) {
	...
	public AlertWaitingList(long messageId, String fromAD, String fromTON, String fromNP, Long toAD, String toAN,
			...
			String alertType, String errorState, Timestamp nextAttempt) {
		super();
		this.messageId = messageId;
		this.fromAD = fromAD;
		this.fromTON = fromTON;
	...
	public String toString() {
		return "AlertWaitingList [messageId=" + messageId + ", fromAD=" + fromAD + ", toAD=" + toAD + ", quantity="
				+ quantity + ", dcs=" + dcs + ", pid=" + pid + ", sendUntil=" + sendUntil + ", systemId=" + systemId
				+ ", sendAttempts=" + sendAttempts + ", errorState=" + errorState + ", nextAttempt=" + nextAttempt
				+ "]";
	}
