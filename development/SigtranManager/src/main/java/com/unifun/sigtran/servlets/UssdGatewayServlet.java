 ...
 * 
 */
package com.unifun.sigtran.servlets;
...
public class UssdGatewayServlet extends HttpServlet {
	...
	IOException
	{
		...
		this.mapLayer = sigStack.getStack().getMap();
		if (mapLayer==null){
			throw new ServletException("Unable to obtain MapStack");
		}
