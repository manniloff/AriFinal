...
ALTER SCHEMA `ussdgate`  DEFAULT COLLATE utf8mb4_general_ci ;
...
INSERT INTO `ussdgate_settings` (`st_type`, `name`, `value`) VALUES ('map', 'serviceCenter', '22505987070');
INSERT INTO `ussdgate_settings` (`st_type`, `name`, `value`) VALUES ('map', 'opc', '5072');
INSERT INTO `ussdgate_settings` (`st_type`, `name`, `value`) VALUES ('map', 'dpc', '6201');
...
INSERT INTO `ussdgate_settings` (`st_type`, `name`, `value`) VALUES ('app', 'threads', '100');
INSERT INTO `ussdgate_settings` (`st_type`, `name`, `value`) VALUES ('app', 'forwardFailure', 'false');

INSERT INTO `ss_route_rule` (`destination_address`, `protocol_type`, `service_code`, `ussd_text`, `proxy_mode`) VALUES ('http://127.0.0.1:7080/UssdGate/test', 'HTTP', '100', '*100#', '0');
INSERT INTO `ss_route_rule` (`destination_address`, `protocol_type`, `service_code`, `ussd_text`, `proxy_mode`) VALUES ('http://127.0.0.1:7080/UssdGate/test', 'HTTP', '100*%', '*100*%#', '0');
