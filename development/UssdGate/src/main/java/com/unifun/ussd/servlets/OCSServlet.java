...
public class OCSServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        OCSQueryCluster ocs = (OCSQueryCluster) request.getServletContext().getAttribute("ocs.cluster");
        AsyncMapProcessor mapProcessor = (AsyncMapProcessor) request.getServletContext().getAttribute("mapProcessor");
        try {
            ...
            JsonMessage ocsQuery = ocs.nextQuery();
            ...
            mapProcessor.send(new UssMessage(ocsQuery), new HttpExecutionContext(context));
        } catch (Throwable e) {
    ...
    private void copyParams(JsonMessage m1, JsonMessage m2) {
        ...
        JsonMapOperation op2 = operation(tcap1);
