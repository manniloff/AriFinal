...
@Entity(name = "smpp_client_error_logs")
public class SMPPClientErrorLog {
	
	public SMPPClientErrorLog() {}
	
	
	
	public SMPPClientErrorLog(int systemId, String sourceAddr, long destAddr, int sequenceNumber, int errorCode,
